# source: https://github.com/zijundeng/pytorch-semantic-segmentation/blob/master/models/config.py
...
root = '~'  # provide the address of root directory which stores pretrained nets 
